...
import {
  ...
  UPDATE_JOB_TYPE_LIST,
  CREATE_CUSTOMER,
  CREATE_CUSTOMER_MODAL,
  CREATE_JOB_TYPE_LIST,
  CREATE_CUSTOMER_TYPE,
  DELETE_JOB_TYPE_LIST,
  GET_CUSTOMER_DETAIL,
...
import {
  ...
  updateJobTypeAPI,
  createJobTypeListAPI,
  deleteJobTypeListAPI,
...
import {
  ...
  setUpdateJobType,
  setUpdateType,
  setJobTypeListDelete,
  setJobTypeListCreate,
  setCustomerTypeDelete,
  setTotalPageCus,
  setCustomerTypeListCreate,
  setCustomerList,
  setCustomerTypeList,
  setDataCustomer,
  setJobTypeList,
...
function* createCustomerInModal(payload) {
  try {
    let { data } = payload;
    if (!data.is_company) {
      data.is_company = false;
...
export default function* customerMiddleware() {
  ...
  yield takeLatest(CREATE_CUSTOMER_MODAL, createCustomerInModal);
