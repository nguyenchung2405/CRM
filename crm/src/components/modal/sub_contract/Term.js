...
import { CREATE_REQUEST, CREATE_REQUEST_SUB_CONTRACT, GET_PRODUCT_ATTRIBUTE, GET_PRODUCT_CHANNEL, GET_PRODUCT_LIST_CONTRACT, GET_PRODUCT_LOCATION, GET_PRODUCT_SPECIAL_FOR_CLIENT, GET_PRODUCT_SUBLOCATION, GET_PRODUCT_TYPE, UPDATE_REQUEST, UPDATE_REQUEST_SUB_CONTRACT } from '../../../title/title';
...
export default function TermModalSubContract(props) {

  let { isShowModal, setIsShowModal, setDataToModal, dataToModal, isUpdateModal, setIsUpdateModal, sub_contract_id, contract_id } = props;
  ...
  const handleOK = () => {
    if (window.location.href.includes("create")) {
      ...
      valueModal.sub_contract_id = sub_contract_id;
      valueModal.contract_id = contract_id;
      if (!isUpdateModal) {
        // console.log(valueModal)
        dispatch({
          type: CREATE_REQUEST_SUB_CONTRACT,
          data: valueModal
        })
      } else {
        dispatch({
          type: UPDATE_REQUEST_SUB_CONTRACT,
          data: valueModal
        })
      }
