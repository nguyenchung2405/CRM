...
export default function TermModal(props) {
  ...
  let { isShowModal, setIsShowModal} = props;
  ...
  return (
    <div className="modal__customer modal__term">
        ...
        footer={
          <>
            <button type="button" className="ant-btn ant-btn-default btn__cancel">
              <span>Hủy</span>
            </button>
            <button type="button" className="ant-btn ant-btn-default btn__add">
              <span>Thêm</span>
            </button> 
          </>
        }
        ...
        onCancel={handleCancel}>
              <div className="modal__content contract__service">
                  <div className="modal__field">
                    <input type="text" placeholder="Ấn phẩm" />
                  </div>
                  <div className="modal__field">
                    <input type="text" placeholder="Vị trí" />
                  </div>
                  <div className="modal__field">
                    <input type="text" placeholder="Quy cách" />
                  </div>
                  <div className="modal__field">
                    <input type="text" placeholder="Thuộc tính" />
                  </div>
                  <div className="modal__field">
