...
export default function ContractRightSubContract(props) {
  ...
  let uri_file = checkMicroFe() === true ? 
    ...
    const {isUpdateDetail, setIsUpdateDetail, contract_id, sub_contract_id} = props;
    ...
    const save = async (key) => {
      try {
          ...
          if(window.location.href.includes("create")){
            ...
            newDetailJustAdd.sub_contract_id = sub_contract_id;
            if(isUpdateDetail){
              dispatch({
                type: UPDATE_DETAIL,
