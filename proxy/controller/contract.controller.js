  ...
  try {
    ...
    if (status !== "undefined" && search !== "true" && status !== undefined) {
      ...
      for (let prop in searchData) {
        if (
          typeof searchData[prop] === "string" &&
          searchData[prop].length > 0
        ) {
      ...
      result = await axios({
        url: `${local}/contract/list?page_size=${page_size}&page=${page}&status=${encodeURI(
          status
        )}&sort_by=id&asc_order=false${queryString}`,
        method: "GET",
        headers: {
...
const getSubContractList = async (req, res) => {
  try {
    ...
    if (status !== "undefined" && search !== "true" && status !== undefined) {
      ...
      result = await axios({
        url: `${local}/contract/subcontract/list?page_size=10&page=1&sort_by=id&asc_order=true${queryString}`,
        method: "GET",
        headers: {
          Authorization: authorization,
        },
      ...
      result = await axios({
        url: `${local}/contract/subcontract/list?page_size=${page_size}&page=${page}&sort_by=id&asc_order=false${queryString}`,
        method: "GET",
        headers: {
          Authorization: authorization,
        },
      ...
      result = await axios({
        url: `${local}/contract/subcontract/list?page_size=${page_size}&page=${page}&sort_by=id&asc_order=false`,
        method: "GET",
        headers: {
          Authorization: authorization,
        },
...
const getFile = async (req, res) => {
  try {
    axios
      .get(req.query.link, { responseType: "arraybuffer" })
      .then((response) => {
...
const getContractType = async (req, res) => {
  try {
    ...
    if (search === "true") {
      result = await axios({
        url: `${local}/contract/type/list?page_size=${page_size}&page=${page}&sort_by=id&asc_order=false&name=${encodeURI(
          name
        )}`,
        method: "GET",
        headers: {
