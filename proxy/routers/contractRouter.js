...
contractRouter.post(
  "/upload-files",
  uploadFilesContract().array("file", 10),
  async (req, res) => res.send(req.files)
);
// Request
...
contractRouter.post(
  "/import-file-excel",
  uploadFileExcelContract().single("file"),
  importFileExcel
);
contractRouter.post(
  "/import-file-excel-sub",
  uploadFileExcelContract().single("file"),
  importFileExcelSubContract
);
// Contract Type
...
// Sub Contract
contractRouter.get("/subcontractlist", getSubContractList);
